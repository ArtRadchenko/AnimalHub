...
14. Написать программу, имитирующую работу реестра домашних животных. В программе долженбыть реализован следующий функционал:  
...
#### Выполнение  
[Код программы и её классы с инкапсуляцией и наследованием по диаграмме ](https://github.com/ArtRadchenko/AnimalHub/tree/main/src).  
Для запуска необходимо скомпилировать все файлы .java:  
```console
javac *.java
java AnimalRegistry
```  
...
![Добавление нового животного](https://github.com/ArtRadchenko/AnimalHub/blob/main/Screenshots/screen01.jpg)  

Просмотр списка команд, которое выполняет животное.  

![Просмотр списка команд](https://github.com/ArtRadchenko/AnimalHub/blob/main/Screenshots/screen02.jpg)